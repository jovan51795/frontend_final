export const homeData1 = {
  ...
  lightTextDesc: true,
  bigText: false,
  topLine: 'ABOUT ABC UNIVESITY',
  headLine: '"ABC UNIVERSITY IS A TOP CHOICE FOR IT AND CS BASED EDUCATION IN THE PHILIPPINES."',
  description:
    'It all started when four visionaries conceptualized setting up a training center to fill very specific manpower needs.' +
    'It was in the early ‘2000s when four entrepreneurs — J. Cabanatuan, M. Mirandilla, G. Miranda, and J. Ong — came together to set up Atanasoff-Berry Computer University (ABC University), a training center that delivers basic programming education to professionals and students who want to learn this new skill.',
...
export const homeData2 = {
  ...
  headLine: 'Be an Atanasoff-Berry Bear!',
  description:
  ...
  imgStart: true,
  img: require('../../assets/images/BerryBear.png'),
  alt: 'student',
  dark: false,
  primary: true,
  darkText: true,
...
export const homeData3 = {
  ...
  description:
    ...
    ' Some of the most impactful lessons you’ll learn will happen among friends, at unplanned hours, at unexpected places.' +
